...
Files: src/modules/client/client.entity.ts, src/migrations/postgres/*-CreateClients.ts, src/migrations/postgres/*-PlainStringIds.ts, src/tests/client/client.entity.test.ts
...
Files: src/common/guards/admin.guard.ts
...
Files: src/modules/client/client.controller.ts, src/modules/client/dto/createClient.dto.ts, src/modules/client/dto/clientResponse.dto.ts, src/modules/client/client.module.ts, test/rest/client.e2e-spec.ts
...
Files: src/modules/user/user.entity.ts, src/migrations/postgres/*-CreateUsers.ts, src/migrations/postgres/*-PlainStringIds.ts, src/tests/user/user.entity.test.ts
...
replaced with `POST /users`, gated by a new `ClientAuthGuard`
(`src/modules/client/clientAuth.guard.ts`) requiring
...
Files: src/modules/user/user.controller.ts, src/modules/client/clientAuth.guard.ts, src/modules/client/client.module.ts (provides+exports `ClientAuthGuard`), src/modules/user/dto/createUser.dto.ts, src/modules/user/dto/userResponse.dto.ts, src/modules/user/user.module.ts (exports `UserRepository`), test/rest/user.e2e-spec.ts
...
Files: scripts/generate-signing-keys.ts, src/secrets/private.jwk.json, src/secrets/public.jwk.json, .gitignore (excludes the two generated files — see design.md's Risks)
...
Files: src/modules/oidc/oidcModel.entity.ts, src/migrations/postgres/*-CreateOidcModels.ts, src/tests/oidc/oidcModel.entity.test.ts
...
Files: src/modules/oidc/oidc.adapter.ts, src/utils/secretCipher.util.ts, src/tests/oidc/oidc.adapter.test.ts, src/tests/secrets/secretCipher.util.test.ts
...
Files: src/modules/oidc/passwordGrant.service.ts, src/modules/oidc/oidcErrors.token.ts, src/tests/oidc/passwordGrant.service.test.ts
