...
`specs/source-material/` is the one sibling folder here that isn't a
feature spec — raw PRDs, ticket exports, and reference docs a feature
starts from, read by `/spec-new` before requirements.md exists. See
`specs/source-material/README.md`.
