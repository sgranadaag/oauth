...
const SECRETS_DIR = join(process.cwd(), 'src', 'core', 'secrets');
...
/**
 * Reads the private signing key from `src/core/secrets/private.pem`.
 *
 ...
 * @throws If `src/core/secrets/private.pem` does not exist.
 */
...
/**
 * Reads the public signing key from `src/core/secrets/public.pem`.
 *
 ...
 * @throws If `src/core/secrets/public.pem` does not exist.
 */
 ...
 * @throws If `src/core/secrets/public.pem` does not exist or is not a valid RSA key.
 */
